...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="../Index/index.html">BBTE-Kozgaz</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <div class="logout">
            <form action="../Logout/temaLogout.php" method="post">
          ...
          <form method="POST" action="../Choose/temaValaszt.php">
              <?php
              ...
              $query = "SELECT Cim FROM tema ORDER BY Cim";
